...
const AddNew = () => {
  ...
  const onFinish = (values) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
          history.push('/app/claim_document_manager/view_document')
      }, 900);
    }, 1300);
  };
    ...
    <div>
      ...
      >
        <div className="p-3 bg-white rounded border">
          <h5 className="text-info m-0">Add/Edit New Document Type</h5>
          <div style={{ width: "60%" }} className="mt-4">
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please enter Document Type Title*",
                },
              ]}
            >
      ...
      >
        <Result
          status="success"
          title="New document type for claim category
          “Medical & Other Expenses” added successfully !"
        />
      </Modal>
    </div>
    </>
