...
export default function MembersDetails() {
 ...
 memberDetail ? <div className='membershipDetailLayout'>
      <div className='membershipDetailLeft'>
        ...
        <p className='membershipDetailText'><CustomIcon svg={History} /> {memberDetail.id}</p>
        <p className='membershipDetailText'><CustomIcon svg={History} /> {new Date(memberDetail.date_of_birth)?.toLocaleDateString()}</p>
        <hr />
        <p className='memberDetailProfileTitle'>Contact</p>
        <p className='membershipDetailText'><CustomIcon svg={History} /> {memberDetail.phone_number}</p>
        <p className='membershipDetailText'><CustomIcon svg={History} /> {memberDetail.address}</p>
        <p className='membershipDetailText'><CustomIcon svg={History} /> {memberDetail.email_address}</p>
